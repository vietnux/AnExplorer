...
public class DriveQuickstart extends BaseDemoActivity {
    private static final String APPLICATION_NAME = "Google Drive API Java Quickstart";
    private static final String TAG = "DriveQuickstart";
    ...
    private static final String CREDENTIALS_FILE_PATH = "/client_secret_369425841449-sd8h0bd04dappgpcudq8rge0o94r9ffe.apps.googleusercontent.com.json";
