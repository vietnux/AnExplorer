...
import static com.tglt.files.explorer.R.id.action_close;
import static com.tglt.files.explorer.R.id.action_feedback;
import static com.tglt.files.explorer.R.id.action_rate;
import static com.tglt.files.explorer.R.id.action_support;
...
//        action_support.setVisibility(hideSupport ? View.GONE : View.VISIBLE);
        action_support.setVisibility( View.VISIBLE );
