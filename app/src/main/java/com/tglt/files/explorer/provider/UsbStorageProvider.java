...
import com.tglt.files.explorer.usb.UsbUtils;
...
import static com.tglt.files.explorer.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "com.tglt.files.explorer.action.USB_PERMISSION";
