...
import com.tglt.files.explorer.demo.events.ListenChangeEventsForFilesActivity;
import com.tglt.files.explorer.demo.events.SubscribeChangeEventsForFilesActivity;
...
public class HomeActivity extends Activity {
    private final Class[] sActivities = new Class[] {CreateEmptyFileActivity.class,
            ...
            ListenChangeEventsForFilesActivity.class, SubscribeChangeEventsForFilesActivity.class, DriveQuickstart.class};
