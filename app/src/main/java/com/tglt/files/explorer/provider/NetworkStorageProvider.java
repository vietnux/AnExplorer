...
import com.tglt.files.explorer.network.NetworkFile;

import static com.tglt.files.explorer.misc.MimeTypes.BASIC_MIME_TYPE;
...
import static com.tglt.files.explorer.provider.ExplorerProvider.ConnectionColumns;
