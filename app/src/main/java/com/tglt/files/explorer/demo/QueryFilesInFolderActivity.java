...
public class QueryFilesInFolderActivity extends BaseDemoActivity {
    ...
    protected void onDriveClientReady() {
        Log.e(TAG, 111+" Sign-in." + 0000 );
        pickFolder()
                .addOnSuccessListener(this,
                        driveId -> {
                            listFilesInFolder(driveId.asDriveFolder() );
                            Log.e(TAG, "Count retrieving files == "+driveId.asDriveFolder() );}
                )
    ...
    private void listFilesInFolder(DriveFolder folder) {
        Log.e(TAG, "oooo retrieving files == " );
        ...
        queryTask
                .addOnSuccessListener(this,
                        metadataBuffer -> {
                            ...
                            Log.e(TAG, "Count retrieving files == "+mResultsAdapter.getCount() );
                } )
                .addOnFailureListener(this, e -> {
