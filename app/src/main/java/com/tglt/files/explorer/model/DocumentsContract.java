...
import com.tglt.files.explorer.misc.ImageUtils;
import com.tglt.files.explorer.misc.OsCompat;
import com.tglt.files.explorer.misc.Utils;
import com.tglt.files.explorer.provider.DocumentsProvider;
import com.tglt.files.explorer.provider.UsbStorageProvider;

import static com.tglt.files.explorer.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.tglt.files.explorer.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.tglt.files.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.tglt.files.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.tglt.files.explorer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.tglt.files.explorer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.tglt.files.explorer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.tglt.files.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.tglt.files.explorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
